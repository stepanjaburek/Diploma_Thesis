...
#----------
stance_model_small <- glmmTMB(stance_bin ~ year + Inflation + government + galtan +
                        (1|speaker)  + (1|party),
                      family = binomial,
                      data = log_data)
...
# Regular model
#----------
stance_model <- glmmTMB(stance_bin ~ year + Inflation + government + galtan + election_period   +
                        eu_election_period  +
                        (1|speaker)  + (1|party),
                      family = binomial,
                      data = log_data)
...
#----------
stance_model_full <- glmmTMB(stance_bin ~ year + Inflation * government + galtan + election_period   +
...
#------
stance_model_fe_small <- feglm(stance_bin ~ Inflation + government + galtan 
                        |  party + year,
                         family = binomial,
                         data = log_data)
summary(stance_model_fe_small)

stance_model_fe <- feglm(stance_bin ~ Inflation + government + galtan + election_period   + 
                           eu_election_period |  party + year,
                         family = binomial,
                         data = log_data)
summary(stance_model_fe)

stance_model_fe_full <- feglm(stance_bin ~ Inflation * government + galtan + election_period   + 
